        ...
        <div className="max-w-3xl bg-white bg-opacity-90 p-8 rounded-lg shadow-lg mb-8"> {/* Added mb-8 for spacing */}
          ...
          <div className="space-y-4 w-full max-w-md mx-auto"> {/* Removed mb-8 from here as it's on the parent div now */}
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <a href={`mailto:${t('email')}`} className="text-lg hover:text-forest-green transition-colors">
                {t('email')}
              </a>
            </div>
            <div className="flex items-center justify-center space-x-2">
              ...
              <a href={`tel:${t('phone').replace(/\s/g, '')}`} className="text-lg hover:text-forest-green transition-colors">
                {t('phone')}
              </a>
            </div>
            <div className="flex items-center justify-center space-x-2">
              ...
              <a href={`https://${t('linkedin')}`} target="_blank" rel="noopener noreferrer" className="text-lg hover:text-forest-green transition-colors">
                {t('linkedin')}
              </a>
            </div>
          </div>
